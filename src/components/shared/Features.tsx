...
const Features = () => {
    // Adjust the row placement using Tailwind's classes
    const baseHeadingStyle = "font-bold text-2xl lg:font-semibold lg:text-3xl z-20";  // Heading should appear second
    const baseParaStyle = "font-medium text-base lg:text-lg z-20";  // Paragraph should appear first
    ...
    return (
        <section className="grid mx-auto max-w-[1500px] auto-rows-min grid-cols-1 lg:grid-cols-3 gap-5 lg:gap-8">
            <div className="bg-purple_bg p-4 md:p-6 rounded-2xl col-span-1 lg:col-span-2 row-span-1 w-full h-full grid grid-cols-2 grid-rows-3 text-purple_text">
                ...
                <p className={`${baseParaStyle} `}>Bookmark your favourite resources and revisit them anytime you wish! Or just download them yourselves!</p>
            </div>
            ...
            <div className="bg-blue_bg p-4 md:p-6 rounded-2xl col-span-1 lg:col-span-2 row-span-1 w-full h-full grid grid-cols-2 grid-rows-3 text-blue_text">
                <h2 className={`${baseHeadingStyle} `}>Track Your Performance</h2>
                <p className={`${baseParaStyle} `}>Reflect on your progress and celebrate milestones towards academic excellence!</p>
            </div>
            ...
            <div className="bg-orange_bg p-4 md:p-6 rounded-2xl col-span-1 lg:col-span-2 row-span-1 w-full h-full grid grid-cols-2 grid-rows-3 text-orange_text group">
                ...
                <p className={`${baseParaStyle} col-start-1 col-span-1`}>Catch the latest tea on exam strategies and tips brewed by tutors with proven track records!</p>
                <div className="col-start-2 row-span-2 relative w-full flex justify-center items-center gap-2">
                    <div className="absolute">
                        <Image src="/images/heroImg22.png" alt="f4" width={320} height={320} 
                            className="rounded-lg -translate-x-8 -translate-y-2 -rotate-2 group-hover:rotate-4 group-hover:-translate-x-6 group-hover:-translate-y-4 duration-100 ease-in-out"/>
                    </div>
                    <div className="absolute z-10 h-[320px] w-[320px]">
